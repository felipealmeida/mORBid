...
struct use_terminal
  <qi::domain
   , terminal_ex<tecorb::iiop::grammar::tag::align, fusion::vector2<Iterator, T> > >
  : mpl::true_ {};

template <>
struct use_lazy_terminal<qi::domain, tecorb::iiop::grammar::tag::align, 2>
  : mpl::true_ {};
...
struct make_primitive
  <terminal_ex<tecorb::iiop::grammar::tag::align, fusion::vector2<Iterator, T> >
   , Modifiers>
{
  typedef tecorb::iiop::grammar::align_parser<Iterator> result_type;
