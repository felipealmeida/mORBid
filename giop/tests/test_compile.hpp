...
template <typename D, typename I, typename T1, typename T2, typename T3, typename T4, typename Enable>
struct use_terminal< test_compile::domain
                     , boost::reference_wrapper<morbid::giop::rule<D, I, T1, T2, T3, T4>const>
                     , Enable>
  : mpl::true_ {};

template <typename D1, typename D2, typename I, typename T1, typename T2, typename T3, typename T4, typename Params
          , typename Enable>
struct use_terminal< test_compile::domain
                     , morbid::giop::parameterized_nonterminal<D1, morbid::giop::rule<D2, I, T1, T2, T3, T4>
                                                               , Params>
                     , Enable>
  : mpl::true_ {};
