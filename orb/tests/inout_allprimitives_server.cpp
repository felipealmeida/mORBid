...
#include "inout_allprimitives.hpp"
#include <morbid/corba.hpp>

#include <fstream>

struct inout_allprimitives_impl
{
  inout_allprimitives_impl(corba::orb orb)
...
int main(int argc, char* argv[])
{
  ...
  inout_allprimitives_impl inout_allprimitives(orb);
  {
    ...
    corba::stringify_object_id(orb, orb.serve_ref< ::inout_allprimitives_concept>
                               (inout_allprimitives), output);
  }
  ...
  assert(inout_allprimitives.foo8_ && inout_allprimitives.foo7_
         && inout_allprimitives.foo6_ && inout_allprimitives.foo5_
         && inout_allprimitives.foo4_ && inout_allprimitives.foo3_
         && inout_allprimitives.foo2_ && inout_allprimitives.foo1_);
}
