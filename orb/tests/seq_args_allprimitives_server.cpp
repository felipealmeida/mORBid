...
struct seq_args_allprimitives_impl
{
  seq_args_allprimitives_impl(corba::orb orb)
    : foo1_(false), foo2_(false), foo3_(false)
    , foo4_(false), foo5_(false), foo6_(false)
    , foo7_(false), foo8_(false)
    , orb(orb) {}

  void foo1(bool b1, std::vector<bool> b)
  {
  ...
  void foo2(char c1, std::vector<char> c)
  {
  ...
  void foo3(double d1, std::vector<double> d)
  {
  ...
  void foo4(float f1, std::vector<float> f)
  {
  ...
  void foo5(morbid::long_ l1, std::vector<morbid::long_> l)
  {
  ...
  void foo6(morbid::octet s1, std::vector<morbid::octet> s)
  {
  ...
  void foo7(short int s1, std::vector<short int> s)
  {
  ...
  void foo8(std::string str1, std::vector<std::string> const& str)
  {
...
int main(int argc, char* argv[])
{
  ...
  seq_args_allprimitives_impl sap(orb);
  {
    ...
    corba::stringify_object_id(orb, orb.serve_ref< ::seq_args_allprimitives_concept> (sap), output);
  }
