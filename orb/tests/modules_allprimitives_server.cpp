...
struct modules_allprimitives_impl : POA_testing::inner::modules_allprimitives
{
  modules_allprimitives_impl(CORBA::ORB_var orb)
...
int main(int argc, char* argv[])
{
  ...
  PortableServer::ObjectId_var oid = poa->activate_object (&modules_allprimitives);
  ...
  assert(modules_allprimitives.foo7_ && modules_allprimitives.foo6_ && modules_allprimitives.foo5_
         && modules_allprimitives.foo4_ && modules_allprimitives.foo3_ && modules_allprimitives.foo2_
         && modules_allprimitives.foo1_);
}
