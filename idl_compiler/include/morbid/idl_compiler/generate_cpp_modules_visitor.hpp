...
#ifndef MORBID_IDL_COMPILER_GENERATE_CPP_MODULES_HPP
#define MORBID_IDL_COMPILER_GENERATE_CPP_MODULES_HPP
...
struct generate_cpp_modules_visitor : boost::default_bfs_visitor
{
  generate_cpp_modules_visitor(output_iterator_type& iterator)
...
struct generate_cpp_poa_modules_visitor : boost::default_bfs_visitor
{
  generate_cpp_poa_modules_visitor(output_iterator_type& iterator)
    : state(new shared_state(iterator))
  {
  }
