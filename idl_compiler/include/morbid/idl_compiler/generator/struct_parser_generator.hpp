...
#ifndef MORBID_IDL_COMPILER_STRUCT_PARSER_GENERATOR_HPP
#define MORBID_IDL_COMPILER_STRUCT_PARSER_GENERATOR_HPP
...
struct struct_parser_generator : karma::grammar
  <OutputIterator, idlc::struct_def_type(struct_)>
{
  ...
  //      << "::morbid::iiop::grammar::align(_r1, 4u) >> float_(_r2)"
  //     )
  //     | (
  //      karma::eps(at_c<0>(_val) == types::floating_point::double_)
  //      << "::morbid::iiop::grammar::align(_r1, 8u) >> double_(_r2)"
  //     )
  //     | (
  ...
  //     << indent << indent << ", " << karma::string[_1 = at_c<0>(_val)] << "(Iterator, bool)> start;" << eol
  ...
  karma::rule<OutputIterator, idlc::struct_def_type(struct_)> start;
};
